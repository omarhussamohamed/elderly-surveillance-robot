...
echo ""
echo "4. Configure rosserial for Arduino:"
echo "   cd ~/Arduino/libraries"
echo "   rm -rf ros_lib"
echo "   rosrun rosserial_arduino make_libraries.py ."
echo ""
echo "5. Open firmware file:"
echo "   ~/catkin_ws/src/elderly_bot/firmware/elderly_bot_esp32.ino"
echo ""
...
echo "   - RPLidar to /dev/ttyUSB0"
echo "   - ESP32 to /dev/ttyUSB1"
echo ""
